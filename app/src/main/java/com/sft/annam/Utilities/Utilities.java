...
public  static String PREFS_LOGIN_STATUS = "LOGIN";
    ...
    public static FetchId fetchId() {




        String  user_id=String.valueOf(mContext.getSharedPreferences(Utilities.PREFS_LOGIN_STATUS, 0).
                getInt("user_id", 0));
        //Log.e(">>>",user_id);
        FetchId fetchId;
        fetchId=new FetchId(user_id);
        //Log.e("gdhf",""+fetchId);
        return fetchId;
    }
    ...
    public void changeHomeFragment(Fragment fragment, String tag,
        ...
        if (fragment != null) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.homemaincontainer, fragment, tag)
                    .commit();
      } else {
            // error in creating fragment
            Toast.makeText(act,"Error in creating fragment",Toast.LENGTH_LONG).show();
